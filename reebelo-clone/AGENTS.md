...
- Main nav should stay focused: All phones, Deals, iPhone, Samsung, Pixel, Warranty, Admin, Instagram, plus WhatsApp as the primary contact action.
...
- Home featured banner should use backend `featured` products and a Microsoft Store-style carousel control bar with previous, pause/play, dots, and next; mobile should keep the product image on the right.
